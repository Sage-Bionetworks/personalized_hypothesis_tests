...
thisCode <- getPermlink(repo, 'generate_paper_figures.R')

## source auxiliary functions for shaping and plotting the 
## analysis results
sourceRepoFile(repo, 'personalized_hypothesis_tests_auxiliary_functions.R')
auxCode <- getPermlink(repo, 'personalized_hypothesis_tests_auxiliary_functions.R')
...
fig1 <- file.path(fig.path, "fig1.ps")
postscript(fig1, width = 10, height = 4)
...
## store in synapse
synFig1 <- synStore(File(fig1, parentId=synFolder), activity=act)
...
fig2 <- file.path(fig.path, "fig2.ps")
postscript(fig2, width = 10, height = 2)
...
## store in synapse
synFig2 <- synStore(File(fig2, parentId=synFolder), activity=act)
...
fig3 <- file.path(fig.path, "fig3.ps")
postscript(fig3, width = 10, height = 6)
...
## store in synapse
synFig3 <- synStore(File(fig3, parentId=synFolder), activity=act)
...
mylim <- c(0, 2.5)
cl <- 1.2; ca <- 1.2; cm <- 1.4
fig4 <- file.path(fig.path, "fig4.ps")
postscript(fig4, width = 10, height = 2)
...
## store in synapse
synFig4 <- synStore(File(fig4, parentId=synFolder), activity=act)
...
fig5 <- file.path(fig.path, "fig5.ps")
postscript(fig5, width = 10, height = 2)
...
## store in synapse
synFig5 <- synStore(File(fig5, parentId=synFolder), activity=act)
...
## generate Figure 6
fig6 <- file.path(fig.path, "fig6.ps")
postscript(fig6, width = 10, height = 2)
...
## store in synapse
synFig6 <- synStore(File(fig6, parentId=synFolder), activity=act)
...
## generate Figure 7
fig7 <- file.path(fig.path, "fig7.ps")
postscript(fig7, width = 10, height = 4)
...
## store in synapse
synFig7 <- synStore(File(fig7, parentId=synFolder), activity=act)
...
fig8 <- file.path(fig.path, "fig8.ps")
postscript(fig8, width = 10, height = 8)
layout(mat)
...
## store in synapse
synFig8 <- synStore(File(fig8, parentId=synFolder), activity=act)
...
fig9 <- file.path(fig.path, "fig9.ps")
postscript(fig9, width = 10, height = 6)
...
## store in synapse
synFig9 <- synStore(File(fig9, parentId=synFolder), activity=act)
